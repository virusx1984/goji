...
| **equipment_status** | `VARCHAR` | 设备状态 | e.g., 'Active', 'Maintenance', 'Retired' |
| **created_at**| `TIMESTAMP`| 创建时间 | Not Null |
| **updated_at**| `TIMESTAMP`| 更新时间 | Not Null |
| **created_by_id**| `INTEGER` | 创建用户ID | 外键, 关联 `users.id` |
| **updated_by_id**| `INTEGER` | 更新用户ID | 外键, 关联 `users.id` |
...
| **name** | `VARCHAR` | 设备组名称 | Not Null, Unique |
| **group_status** | `VARCHAR` | 设备组状态 | e.g., 'Active', 'Inactive' |
| **description**| `VARCHAR` | 设备组描述 | |
| **created_at**| `TIMESTAMP`| 创建时间 | Not Null |
| **updated_at**| `TIMESTAMP`| 更新时间 | Not Null |
| **created_by_id**| `INTEGER` | 创建用户ID | 外键, 关联 `users.id` |
| **updated_by_id**| `INTEGER` | 更新用户ID | 外键, 关联 `users.id` |
...
| **equipment_id**| `INTEGER` | 关联到具体设备 | 外键, 关联 `equipments.id` |
| **created_at**| `TIMESTAMP`| 创建时间 | Not Null |
| **created_by_id**| `INTEGER` | 创建用户ID | 外键, 关联 `users.id` |
...
| **semi_pn** | `VARCHAR` | (文本)相关的半成品料号 | 可为空 |
| **notes** | `TEXT` | (文本)工艺备注 | |
