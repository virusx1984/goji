"""Refactored models to use Mixins

Revision ID: c5a6270a4643
Revises: 
Create Date: 2025-12-15 23:24:28.589445
...
def upgrade():
    ...
    op.create_table('gj_password_reset_tokens',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('token', sa.String(length=100), nullable=False),
    sa.Column('expiration_date', sa.DateTime(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['gj_users.id'], name=op.f('fk_gj_password_reset_tokens_user_id_gj_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_gj_password_reset_tokens')),
    sa.UniqueConstraint('token', name=op.f('uq_gj_password_reset_tokens_token'))
    )
    ...
    sa.Column('description', sa.String(length=500), nullable=True),
    sa.Column('end_cust_id', sa.Integer(), nullable=True),
    sa.Column('created_by_id', sa.Integer(), nullable=True),
    sa.Column('updated_by_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['end_cust_id'], ['gj_customers.id'], name=op.f('fk_gj_products_end_cust_id_gj_customers')),
    ...
    sa.Column('int_product_id', sa.Integer(), nullable=False),
    sa.Column('int_ver', sa.String(length=50), nullable=False),
    sa.Column('pcs_per_strip', sa.Integer(), nullable=True),
    sa.Column('strip_per_panel', sa.Integer(), nullable=True),
    sa.Column('is_default', sa.Boolean(), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('created_by_id', sa.Integer(), nullable=True),
    sa.Column('updated_by_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['int_product_id'], ['gj_internal_products.id'], name=op.f('fk_gj_routings_int_product_id_gj_internal_products')),
    ...
    sa.Column('current_layer_id', sa.Integer(), nullable=True),
    sa.Column('next_layer_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['current_layer_id'], ['gj_layer_definitions.id'], name=op.f('fk_gj_layer_structures_current_layer_id_gj_layer_definitions')),
    sa.ForeignKeyConstraint(['next_layer_id'], ['gj_layer_definitions.id'], name=op.f('fk_gj_layer_structures_next_layer_id_gj_layer_definitions')),
    sa.ForeignKeyConstraint(['routing_id'], ['gj_routings.id'], name=op.f('fk_gj_layer_structures_routing_id_gj_routings')),
    sa.ForeignKeyConstraint(['updated_by_id'], ['gj_users.id'], name=op.f('fk_gj_layer_structures_updated_by_id_gj_users')),
    ...
    sa.Column('multiplier', sa.Numeric(precision=12, scale=6), nullable=False),
    ...
    sa.Column('raw_run_time_val', sa.Numeric(precision=12, scale=6), nullable=True),
    sa.Column('raw_run_time_uom', sa.String(length=20), nullable=True),
    sa.Column('items_per_raw_uom', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['updated_by_id'], ['gj_users.id'], name=op.f('fk_gj_alternate_materials_updated_by_id_gj_users')),
...
def downgrade():
    ...
    op.drop_table('gj_password_reset_tokens')
