...
class BusinessUnit(ModelBase):
    ...
    """
    id = db.Column(db.Integer, Sequence('gj_business_unit_id_seq'), primary_key=True)
...
class LegalEntity(ModelBase):
    ...
    """
    id = db.Column(db.Integer, Sequence('gj_legal_entity_id_seq'), primary_key=True)
...
class FactoryCluster(ModelBase):
    ...
    """
    id = db.Column(db.Integer, Sequence('gj_factory_cluster_id_seq'), primary_key=True)
...
class Plant(ModelBase):
    ...
    """
    id = db.Column(db.Integer, Sequence('gj_plant_id_seq'), primary_key=True)
